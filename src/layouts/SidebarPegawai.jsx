    ...
    <>
      ...
      >
        ...
        >
          ...
          <div>
            ...
            <small className="d-block text-success fw-semibold" style={{ fontSize: "0.62rem" }}>
              PORTAL PEGAWAI &bull; {activeItemObj?.label}
            </small>
          </div>
        </div>
        ...
        <div className="d-flex align-items-center gap-2">
          ...
          <button
            className="btn btn-sm btn-success fw-bold px-2 py-1 rounded-2 d-flex align-items-center gap-1 shadow-sm"
            onClick={() => setIsMobileOpen(!isMobileOpen)}
            aria-label="Toggle Menu Pegawai"
          >
      ...
      >
        <div>
          {/* BRAND HEADER */}
          <div
            className="d-flex align-items-center justify-content-between gap-3 p-2 rounded-3 mb-3 hover-lift"
            style={{
              cursor: "pointer",
        ...
        <div className="pt-3 border-top" style={{ borderColor: darkMode ? "#1a2238" : "#e2e8f0" }}>
          <div
            ...
            style={{
              ...
              border: darkMode ? "1px solid #1a2238" : "#e2e8f0",
            }}
          >
            <div className="d-flex align-items-center gap-2 overflow-hidden">
              ...
              <div className="overflow-hidden">
                ...
                <small
                  ...
                  title={currentUser?.role || currentUser?.jabatan}
                >
                  {currentUser?.role || "Perawat Bangsal"}
                </small>
              </div>
            </div>
